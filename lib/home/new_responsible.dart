...
class NewResponsible extends StatefulWidget {
  final inheritResponsible;
  NewResponsible({Key key, @required this.inheritResponsible})
      : super(key: key);
  @override
  _NewResponsibleState createState() => _NewResponsibleState();
}
...
class _NewResponsibleState extends State<NewResponsible> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        key: scaffoldKey,
        appBar: AppBar(
          title: Text('Informacion del responsable'),
          ...
          onPressed: () {
            showDialog<bool>(
              ...
              builder: (c) => AlertDialog(
                title: Text('Aviso'),
                content: Text('¿Crear responsable?'),
                actions: [
                  FlatButton(
                      child: Text('Si'),
                      onPressed: () async {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ResponsibleList(
                                paramResponsible: widget.inheritResponsible,
                              ),
                            ),
                          );
                          scaffoldKey.currentState.showSnackBar(
                            SnackBar(
                              content: Text('Responsable creado'),
